...
class VideoTracker(object):
    ...
    def __enter__(self):
        ...
        if self.args.save_path:
            ...
            self.save_video_path = os.path.join(self.args.save_path, "results.mp4v")
    ...
    def run(self):
        ...
        while self.vdo.grab():
            ...
            if ref is True:
                ...
                ##print(np.uint8(frame))

                bbox_xywh, cls_conf,cls_ids= self.detector.new_detect(frame)###输出边界框、置信度、类别id
...
if __name__ == "__main__":
    ...
    # with VideoTracker(args, video_path='./002.MP4') as vdo_trk:
        vdo_trk.run()
